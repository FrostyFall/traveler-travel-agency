    ...
    if (isDelayExpired) {
      ...
      if (!validated.name || !validated.phone || !validated.email) {
        setNotification({
          ...
          msg: !validated.name
            ? "Name is incorrect. Name should only contain characters."
            : !validated.phone
            ? "Phone is incorrect. Use pattern +XXXX(1-4) YYYY(1-4) ZZZNNNN."
        ...
        try {
          await axios.post(
            "https://wandering-garment-eel.cyclic.app/api/v1/bookTour",
            {
              fullName: nameInput,
              phone: phoneInput,
              email: emailInput,
      ...
      <div className='main-container'>
        <div className='inner-container'>
          <h3 className='main-heading'>
            Ready to try it out? Fill the form below
          </h3>
          <div className='booking-container'>
            <div className='booking'>
              <div className='options'>
                <button
                  className={"standard" + (plans.standard ? " selected" : "")}
                ...
                <button
                  className={"premium" + (plans.premium ? " selected" : "")}
                  onClick={(e) => optionClickHandler(e)}
                >
                  <div className='info'>
                    <h4>Premium</h4>
            ...
            <button type='button' onClick={bookTour}>
              Book Tour
            </button>
          </div>
        </div>
